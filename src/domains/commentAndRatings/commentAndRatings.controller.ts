...
import { CreateCommentAndRatingDto,
...
export class CommentAndRatingsController {
  ...
  async Delete(
    ...
    try {
      return this.commentAndRatingsService.deleteOne({_id:commentAndRatingID.commentAndRatingID})
    } catch (error) {
      throw error
    }
  }
  ...
  async updateOne(
    ...
    try {
      return this.commentAndRatingsService.updateOne({data, query:{_id:commentAndRatingID.commentAndRatingID}})
    } catch (error) {
      throw error
    }
  }
