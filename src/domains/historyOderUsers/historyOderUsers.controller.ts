...
export class NoticationsController {
  ...
  async Delete(
    ...
    try {
      return this.noticationsService.deleteOne({_id:notificationID.notificationID})
    } catch (error) {
      throw error
    }
  }
  ...
  async updateOne(
    ...
    try {
      return this.noticationsService.updateOne({data, query:{_id:notificationID.notificationID}})
    } catch (error) {
      throw error
    }
  }
